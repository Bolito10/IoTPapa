...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary navbar-tr">
                      <a class="navbar-brand" href="#"><img src ="./Imagenes/logistica.jpeg" style="border-radius: 50%;" width="150" heigth="150" ></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                          ...
                          <a class="nav-item nav-link" href="tabla.php">INICIO</a>
...
<br>
<div align="center">
  <h1>BITACORA COMPLETA DE CARGA Y RASTREO DE CARGA. </h1>
  <h3>Selecciona alguna ruta que desees para saber la hora y fecha en la que el vehiculo hizo su paso. </h3>
</div>
    
      <pre>
            <?php
            $saludo = $_GET['LATITUD'];
            $saludo2 = $_GET['LONGITUD'];
            ?>
    </pre>
    <?php 
        $buscador = mysqli_query($conexion,"SELECT * FROM seguimiento order by hora;");
...
<script>
  function iniciarMap(){
    var coord = {lat:<?=$saludo?> ,lng:<?=$saludo2?> };
...
<?php }?>
<?php 
        $buscador2 = mysqli_query($conexion,"SELECT * FROM seguimiento order by hora");
...
<div class="table-responsive ">
      ...
      <th scope="col">Humedad</th>
            ...
            <th scope="col" style="vertical-align:middle;">Ver Ruta</th>
    ...
    <td style="vertical-align:middle;"><a href="Registros.php?LATITUD=<?php echo $resultado2['latitud']?>& LONGITUD=<?php echo $resultado2['longitud']?>" class="btn btn-primary" >  
        Ver Ruta 
        </td>
